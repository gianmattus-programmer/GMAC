...
function syncButtons(){cancelAnimationFrame(raf);raf=requestAnimationFrame(()=>{$$('[data-share-capture="fixture"]').forEach(btn=>{const panel=btn.closest('.gm-fixture-panel');if(!isKnockout(panel))return;btn.dataset.pdfReady='39.1';btn.textContent='DESCARGAR FIXTURE PDF ↓';btn.setAttribute('aria-label','Descargar fixture completo en PDF vectorial')})})}
