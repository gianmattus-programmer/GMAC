(()=>{
  ...
  if(document.querySelector('[data-share-capture="fixture"]')||document.body.classList.contains('gm-detail-page')){
    if(!document.querySelector('link[data-gmac-bracket-v36]')){
      const css=document.createElement('link');css.rel='stylesheet';css.href='assets/css/bracket-v36.css?v=36.9';css.dataset.gmacBracketV36='';
    ...
    const pdf=document.createElement('script');pdf.src='assets/js/shared/fixture-pdf-v39.js?v=39.0';pdf.async=false;document.head.appendChild(pdf);
